...
bool Map::canWalk(Rectangle hitbox) const{
    int top = (int)(hitbox.y / tileSize);
    int bottom = (int)((hitbox.y + hitbox.height + 1) / tileSize);
    int right = (int)((hitbox.x + hitbox.width + 1) / tileSize);
    int left = (int)(hitbox.x / tileSize);
